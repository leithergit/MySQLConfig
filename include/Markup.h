...
// Major build options
// MARKUP_WCHAR wide char (2-unsigned char UTF-16 on Windows, 4-unsigned char UTF-32 on Linux and OS X)
// MARKUP_MBCS ANSI/double-unsigned char strings on Windows
...
#endif // not WINCONV
#else // not MBCS/double unsigned char
#define MCD_ENC MCD_T("UTF-8")
#define MCD_CLEN(p) 1
#endif // not MBCS/double unsigned char
