...
#define AnalysisData		AnalysisDataW
...
// 取指定参数的一个字节
#define  GetAddrByte(p,n)  ((unsigned char*)&p)[n]
#define  GetAddrInt16(p)	MAKEWORD(((unsigned char *)&p)[1],((unsigned char *)&p)[0])
#define  GetAddrInt32(p)	MAKELONG(GetAddrInt16(((unsigned char *)&p)[2]),GetAddrInt16(p))
#define  GetAddrInt64(p)	MAKEUINT64(GetAddrInt32(((unsigned char *)&p)[4]),GetAddrInt32(p))
...
int RunWinProcess(LPCSTR szProcess, LPCSTR szArgument, LPCSTR szWorkDirectory = nullptr);