...
QIPAddress::QIPAddress(QWidget *parent) : QLineEdit(parent)
{
	...
	txtIP1->setAttribute(Qt::WA_InputMethodEnabled, false);	// 禁止开启输入法
	...
	txtIP2->setAttribute(Qt::WA_InputMethodEnabled, false);	// 禁止开启输入法
	...
	txtIP3->setAttribute(Qt::WA_InputMethodEnabled, false);	// 禁止开启输入法
	...
	txtIP4->setAttribute(Qt::WA_InputMethodEnabled, false);	// 禁止开启输入法
